'use client';
import { setArchiveRemark } from '@/apis/archive';
...
const RemarkModal: React.FC<{
  ...
  const t = useTranslations('app.pages.archive.remark');
  ...
  const { loading: submitting, run: doSubmit } = useRequest(setArchiveRemark, {
    manual: true,
    onSuccess: () => {
